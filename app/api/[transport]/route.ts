...
const handler = createMcpHandler(
  (server) => {
    ...
    server.registerTool("get_payment", {
      ...
      inputSchema: { id: z.number().describe("Payment ID") },
    }, async ({ id }) => {
    ...
    server.registerTool("get_customer", {
      ...
      inputSchema: { id: z.number().describe("Customer ID") },
    }, async ({ id }) => {
    ...
    server.registerTool("get_license", {
      ...
      inputSchema: { id: z.number().describe("License ID") },
    }, async ({ id }) => {
    ...
    server.registerTool("get_coupon", {
      ...
      inputSchema: { id: z.number().describe("Coupon ID") },
    }, async ({ id }) => {
    ...
    server.registerTool("update_webhook_endpoint", {
      title: "Update Webhook",
      description: "Update a webhook endpoint",
      inputSchema: { id: z.number(), name: z.string(), url: z.string() },
    }, async ({ id, ...rest }) => {
    ...
    server.registerTool("get_event_tickets", {
      ...
      inputSchema: { id: z.number().describe("Event ID") },
    }, async ({ id }) => {
